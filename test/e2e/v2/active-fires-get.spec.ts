...
} from '../utils/query-mocks';
import { mockValidateRequestWithApiKey } from '../utils/mock';
...
describe('V2 - Get active fires tests', () => {
    ...
    it('V2 Get correct downloadUrls (200) links when when querying for admin level data', async () => {
        ...
        const response = await requester
            .get(`/api/v2/viirs-active-fires/admin/LBR?period=2020-04-22%2C2020-04-23`)
    ...
    it('V2 Get subscription response for admin level data', async () => {
        ...
        const response = await requester
            .get(`/api/v2/viirs-active-fires/admin/LBR?period=2020-04-22%2C2020-04-23&forSubscription=true`)
            .set('x-api-key', 'api-key-test');
    ...
    it('V2 Get group response for admin level data', async () => {
        ...
        const response = await requester
            .get(`/api/v2/viirs-active-fires/admin/LBR?period=2020-04-22%2C2020-04-23&group=true`)
            .set('x-api-key', 'api-key-test');
    ...
    it('V2 Get response for wdpa data', async () => {
        ...
        const response = await requester
            .get(`/api/v2/viirs-active-fires/wdpa/10?period=2020-04-22%2C2020-04-23`)
            .set('x-api-key', 'api-key-test');
    ...
    it('V2 Get response for geostore data', async () => {
        ...
        const response = await requester
            .get(`/api/v2/viirs-active-fires?geostore=351cfa10a38f86eeacad8a86ab7ce845&period=2020-04-22%2C2020-04-23`)
            .set('x-api-key', 'api-key-test');
    ...
    it('V2 Get response for POST geojson', async () => {
        ...
        const response = await requester
            .post(`/api/v2/viirs-active-fires?period=2020-04-22%2C2020-04-23`)
            .set('x-api-key', 'api-key-test')
            .send({
                geojson: {
                    type: 'Polygon',
    ...
    it('V2 Get response from latest', async () => {
        ...
        const response = await requester
            .get(`/api/v2/viirs-active-fires/latest`)
            .set('x-api-key', 'api-key-test');
